...
class AccesoriosControllerTest < ActionController::TestCase
  ...
  test "should create accesorio" do
    assert_difference('Accesorio.count') do
      post :create, accesorio: { description: @accesorio.description, name: @accesorio.name, origin: @accesorio.origin, price: @accesorio.price }
    end
  ...
  test "should update accesorio" do
    put :update, id: @accesorio, accesorio: { description: @accesorio.description, name: @accesorio.name, origin: @accesorio.origin, price: @accesorio.price }
    assert_response 204
  end
